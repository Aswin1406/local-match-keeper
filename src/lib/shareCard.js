import { cards, overs, resultText, scoreLine, SPORT_META, wickets, } from "@/lib/matches";
const W = 1080;
const H = 1080;
...
export async function renderScorecardPng(match) {
    ...
    const statusLine = match.status === "completed"
